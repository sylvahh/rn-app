...
import ResturantCategories, { ResturantCategoriesSkema } from '../components/ui/business/resturant-category';
  ...
  return (
    <View style={styles.container}>
      ...
      {isLoading ? (
        ...
        businesses.length > 0 && <ResturantCategories searchedTitle={searchedTitle} businesses={businesses} />
      )}
